...
# Custom prompts for box detection. 
# You can modify this list based on your dataset and needs.
PROMPTS = [
    "person",
    "human body",
    "decomposed body",
...
def fill_internal_holes(mask_bin):
    ...
    # Fill outer background from padded corner
    cv2.floodFill(flood, flood_mask, (0, 0), 255)

    # Background not connected to border = internal holes
    flood_inv = cv2.bitwise_not(flood)

    # Merge holes into foreground
